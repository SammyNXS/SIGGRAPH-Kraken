...
public class RangedWeapon : Weapon 
{
	...
	public void MainAction()
	{
		if(mainActionFlag)
		{
			...
			{
				//Eventually needs to be fixed-.4f added to y transforn to account for the axis being incorrect
				...
				//Eventually needs to be fixed-90 degrees added to the y-axis to account for the axis being incorrect
